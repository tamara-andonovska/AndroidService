...
public class Service extends android.app.Service {
    ...
    private static String CUSTOM = "Tamara";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(CUSTOM, "restarting Service !!");
        counter = 0;
    ...
    public void restartForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Log.d(CUSTOM, "restarting foreground");
            try {
                ...
                Log.d(CUSTOM, "restarting foreground successful");
                startTimer();
            } catch (Exception e) {
                Log.e(TAG, "Error in notification " + e.getMessage());
                Log.d(CUSTOM, "Error in notification " + e.getMessage());
            }
        }
    }
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        Log.d(CUSTOM, "onTaskRemoved called");
        // restart the never ending service
        Intent broadcastIntent = new Intent(Globals.RESTART_INTENT);
        sendBroadcast(broadcastIntent);
